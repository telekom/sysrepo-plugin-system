...
namespace sub::change {
    ...
    /**
     * @brief sysrepo-plugin-generator: Generated module change functor for path /ietf-system:system/authentication/user[name='%s']/name.
     */
    class AuthUserNameModuleChangeCb {
    public:
        /**
         * sysrepo-plugin-generator: Generated default constructor.
         *
         ...
         *
         */
        AuthUserNameModuleChangeCb(std::shared_ptr<ietf::sys::ModuleChangeContext> ctx);
    ...
    /**
     * @brief sysrepo-plugin-generator: Generated module change functor for path /ietf-system:system/authentication/user[name='%s']/password.
     */
    class AuthUserPasswordModuleChangeCb {
    public:
        /**
         * sysrepo-plugin-generator: Generated default constructor.
         *
         ...
         *
         */
        AuthUserPasswordModuleChangeCb(std::shared_ptr<ietf::sys::ModuleChangeContext> ctx);
    ...
    public:
         ...
         *
         */
        AuthUserAuthorizedKeyModuleChangeCb(std::shared_ptr<ietf::sys::ModuleChangeContext> ctx);
