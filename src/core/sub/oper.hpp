...
namespace sub::oper {
    ...
    public:
         ...
         *
         */
        HostnameOperGetCb(std::shared_ptr<ietf::sys::OperContext> ctx);
    ...
    public:
         ...
         *
         */
        ClockTimezoneNameOperGetCb(std::shared_ptr<ietf::sys::OperContext> ctx);
    ...
    public:
         ...
         *
         */
        ClockTimezoneUtcOffsetOperGetCb(std::shared_ptr<ietf::sys::OperContext> ctx);
    ...
    public:
         ...
         *
         */
        AuthUserAuthenticationOrderOperGetCb(std::shared_ptr<ietf::sys::OperContext> ctx);
    ...
    public:
         ...
         *
         */
        AuthUserNameOperGetCb(std::shared_ptr<ietf::sys::OperContext> ctx);
    ...
    public:
         ...
         *
         */
        AuthUserPasswordOperGetCb(std::shared_ptr<ietf::sys::OperContext> ctx);
    ...
    public:
         ...
         *
         */
        AuthUserAuthorizedKeyNameOperGetCb(std::shared_ptr<ietf::sys::OperContext> ctx);
    ...
    public:
         ...
         *
         */
        AuthUserAuthorizedKeyAlgorithmOperGetCb(std::shared_ptr<ietf::sys::OperContext> ctx);
    ...
    public:
         ...
         *
         */
        AuthUserAuthorizedKeyKeyDataOperGetCb(std::shared_ptr<ietf::sys::OperContext> ctx);
    ...
    public:
         ...
         *
         */
        AuthUserAuthorizedKeyOperGetCb(std::shared_ptr<ietf::sys::OperContext> ctx);
    ...
    public:
         ...
         *
         */
        AuthUserOperGetCb(std::shared_ptr<ietf::sys::OperContext> ctx);
    ...
    public:
         ...
         *
         */
        AuthOperGetCb(std::shared_ptr<ietf::sys::OperContext> ctx);
